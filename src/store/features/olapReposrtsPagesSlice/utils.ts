...
interface FiledsForPivotTableType {
  [key: string]: string
}
...
export function createAtrributeFilters(filters: OlapReportFiltersType[], fieldsForPivotTable: FiledsForPivotTableType) {
  // Функция для безопасного парсинга JSON

  // Парсим поля с обработкой ошибок
